...
namespace CH341Sharp
{
	public class CH341 : IDisposable
	{
		...
		public static readonly int CH341A_DEFAULT_VID = 0x1a86;
		public static readonly int CH341A_DEFAULT_PID = 0x5512;
		...
		public CH341(UsbRegistry registry)
		{
			...
			registry.Open(out CH341device);
			Constructors_common();
		}

		public CH341() : this(CH341A_DEFAULT_VID, CH341A_DEFAULT_PID)
		{
		}
		...
		/// <summary>
		/// Цrite a byte and return the ack bit
		/// </summary>
